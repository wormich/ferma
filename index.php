        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="card "
                     ...
                     data-iq-ease="none"
                >
                    <div class="hero-image p-3" style="background: url('/local/templates/main/assets/images/layouts/01.png') no-repeat center right;background-size: cover;background-position: center;">
                        ...
                        <div class="col-xl-12 col-lg-12 dish-card-horizontal mt-2">
                            <div class="row row-cols-1 row-cols-md-2 row-cols-xl-2 row-cols-xxl-4">
                                ...
                                >
                                    <div class="card card-white dish-card profile-img mb-0">
                                        <div class="profile-img21">
                                            <img src="/local/templates/main/assets/images/layouts/16.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                                 alt="profile-image">
                                            <img src="/local/templates/main/assets/images/layouts/16.png" class="img-fluid rounded-pill avatar-170 hover-image " alt="profile-image"
                                                 data-iq-gsap="onStart"
                                                 data-iq-opacity="0"
                                                 data-iq-scale=".6"
                                                 data-iq-rotate="180"
                                ...
                                >
                                    <div class="card card-white dish-card profile-img mb-0">
                                        <div class="profile-img21">
                                            <img src="/local/templates/main/assets/images/layouts/15.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                                 alt="profile-image">
                                            <img src="/local/templates/main/assets/images/layouts/15.png" class="img-fluid rounded-pill avatar-170 hover-image " alt="profile-image"
                                                 data-iq-gsap="onStart"
                                                 data-iq-opacity="0"
                                                 data-iq-scale=".6"
                                                 data-iq-rotate="180"
                                ...
                                >
                                    <div class="card card-white dish-card profile-img mb-0">
                                        <div class="profile-img21">
                                            <img src="/local/templates/main/assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                                 alt="profile-image">
                                            <img src="/local/templates/main/assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-170 hover-image " alt="profile-image"
                                                 data-iq-gsap="onStart"
                                                 data-iq-opacity="0"
                                                 data-iq-scale=".6"
                                                 data-iq-rotate="180"
                                ...
                                >
                                    <div class="card card-white dish-card profile-img mb-0">
                                        <div class="profile-img21">
                                            <img src="/local/templates/main/assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                                 alt="profile-image">
                                            <img src="/local/templates/main/assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-170 hover-image " alt="profile-image"
                                                 data-iq-gsap="onStart"
                                                 data-iq-opacity="0"
                                                 data-iq-scale=".6"
                                                 data-iq-rotate="180"
                                    ...
                                    <div class="card card-white dish-card2 index">
                                        <div class="card-body ">
                                            <div class="d-flex profile-img1">
                                                <div class="profile-img31">
                                                    <img src="/local/templates/main/assets/images/layouts/17.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                                    <img src="/local/templates/main/assets/images/layouts/17.png" class="img-fluid rounded-pill avatar-130 hover-image" alt="profile-image"
                                                         data-iq-gsap="onStart"
                                                         data-iq-opacity="0"
                                                         data-iq-scale=".6"
                                                         data-iq-rotate="180"
                                     ...
                                     <span class="text-primary">
                                         ...
                                         <small>Top of the week</small>
                                                    ...
                                                    <h6 class="mb-3 mt-3 heading-title fw-bolder">Italian Salad</h6>
                                        ...
                                        <div class="card-body ">
                                            <div class="d-flex profile-img1">
                                                <div class="profile-img31">
                                                    <img src="/local/templates/main/assets/images/layouts/19.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                                    <img src="/local/templates/main/assets/images/layouts/19.png" class="img-fluid rounded-pill avatar-130 hover-image" alt="profile-image"
                                                         data-iq-gsap="onStart"
                                                         data-iq-opacity="0"
                                                         data-iq-scale=".6"
                                                         data-iq-rotate="180"
                                ...
                                >
                                    <div class="card card-white dish-card2 index">
                                        <div class="card-body ">
                                            <div class="d-flex profile-img1">
                                                <div class="profile-img31">
                                                    <img src="/local/templates/main/assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                                    <img src="/local/templates/main/assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-130 hover-image" alt="profile-image"
                                                         data-iq-gsap="onStart"
                                                         data-iq-opacity="0"
                                                         data-iq-scale=".6"
                                                         data-iq-rotate="180"
                                     ...
                                     <span class="text-primary">
                                        ...
                                        <div class="card-body ">
                                            <div class="d-flex profile-img1">
                                                <div class="profile-img31">
                                                    <img src="/local/templates/main/assets/images/layouts/20.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                                    <img src="/local/templates/main/assets/images/layouts/20.png" class="img-fluid rounded-pill avatar-130 hover-image" alt="profile-image"
                                                         data-iq-gsap="onStart"
                                                         data-iq-opacity="0"
                                                         data-iq-scale=".6"
                                                         data-iq-rotate="180"
                                ...
                                >
                                    <div class="card card-white dish-card2 index">
                                        <div class="card-body ">
                                            <div class="d-flex profile-img1">
                                                <div class="profile-img31">
                                                    <img src="/local/templates/main/assets/images/layouts/18.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                                    <img src="/local/templates/main/assets/images/layouts/18.png" class="img-fluid rounded-pill avatar-130 hover-image" alt="profile-image"
                                                         data-iq-gsap="onStart"
                                                         data-iq-opacity="0"
                                                         data-iq-scale=".6"
                                                         data-iq-rotate="180"
                                     ...
                                     <span class="text-primary">
                                        ...
                                        <div class="card-body ">
                                            <div class="d-flex profile-img1">
                                                <div class="profile-img31">
                                                    <img src="/local/templates/main/assets/images/layouts/21.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                                    <img src="/local/templates/main/assets/images/layouts/21.png" class="img-fluid rounded-pill avatar-130 hover-image" alt="profile-image"
                                                         data-iq-gsap="onStart"
                                                         data-iq-opacity="0"
                                                         data-iq-scale=".6"
                                                         data-iq-rotate="180"
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="text-center profile-img51">
                                    <div class="profile-img41 ">
                                        <img src="/local/templates/main/assets/images/layouts/8.png" class="img-fluid rounded-pill " alt="profile-image">
                                    </div>
                                ...
                                <div class="rounded-pill bg-soft-primary iq-my-cart">
                                    <div class="d-flex align-items-center justify-content-between profile-img4">
                                        <div class="profile-img11">
                                            <img src="/local/templates/main/assets/images/layouts/13.png" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                                            <img src="/local/templates/main/assets/images/layouts/13.png" class="img-fluid rounded-pill avatar-115"  alt="img"
                                                 data-iq-gsap="onStart"
                                                 data-iq-opacity="0"
                                                 data-iq-scale=".6"
                                                 data-iq-rotate="180"
                              ...
                              <path d="M21 5.97686C21 5.56588 20.6761 5.24389 20.2871 5.24389H17.3714C16.7781 5.24389 16.2627 4.8219 16.1304 4.22692L15.967 3.49795C15.7385 2.61698 14.9498 2 14.0647 2H9.93624C9.0415 2 8.26054 2.61698 8.02323 3.54595L7.87054 4.22792C7.7373 4.8219 7.22185 5.24389 6.62957 5.24389H3.71385C3.32386 5.24389 3 5.56588 3 5.97686V6.35685C3 6.75783 3.32386 7.08982 3.71385 7.08982H20.2871C20.6761 7.08982 21 6.75783 21 6.35685V5.97686Z" fill="#E60A0A"/>
                                ...
                                <div class="rounded-pill bg-soft-primary iq-my-cart">
                                    <div class="d-flex align-items-center justify-content-between profile-img4 mt-4">
                                        <div class="profile-img11">
                                            <img src="/local/templates/main/assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                                            <img src="/local/templates/main/assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-115"  alt="img"
                                                 data-iq-gsap="onStart"
                                                 data-iq-opacity="0"
                                                 data-iq-scale=".6"
                                                 data-iq-rotate="180"
                           ...
                           <span class="mb-1">
                              ...
                              <path d="M21 5.97686C21 5.56588 20.6761 5.24389 20.2871 5.24389H17.3714C16.7781 5.24389 16.2627 4.8219 16.1304 4.22692L15.967 3.49795C15.7385 2.61698 14.9498 2 14.0647 2H9.93624C9.0415 2 8.26054 2.61698 8.02323 3.54595L7.87054 4.22792C7.7373 4.8219 7.22185 5.24389 6.62957 5.24389H3.71385C3.32386 5.24389 3 5.56588 3 5.97686V6.35685C3 6.75783 3.32386 7.08982 3.71385 7.08982H20.2871C20.6761 7.08982 21 6.75783 21 6.35685V5.97686Z" fill="#E60A0A"/>
                                ...
                                <div class="rounded-pill bg-soft-primary iq-my-cart">
                                    <div class="d-flex align-items-center justify-content-between profile-img4 mt-4">
                                        <div class="profile-img11">
                                            <img src="/local/templates/main/assets/images/layouts/11.png" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                                            <img src="/local/templates/main/assets/images/layouts/11.png" class="img-fluid rounded-pill avatar-115"  alt="img"
                                                 data-iq-gsap="onStart"
                                                 data-iq-opacity="0"
                                                 data-iq-scale=".6"
                                                 data-iq-rotate="180"
                    ...
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="position-relative">
                            <img src="/local/templates/main/assets/images/layouts/40.png" alt="img-1" class="img-fluid img-user">
                        </div>
                    </div>
                </div>
            </div>
